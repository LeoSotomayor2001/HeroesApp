...
export function HeroPage() {
  ...
  return superheroData ? (
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-semibold">
                      {new Date().getFullYear() -
                        Number.parseInt(
                          String(superheroData.firstAppearance || "0"),
                        )}{" "}
                      años
                    </span>
                  </div>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100 backdrop-blur-sm animate-fade-in">
        {/* Icono decorativo */}
        <div className="mx-auto w-24 h-24 bg-linear-to-tr from-slate-900 to-blue-900 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-blue-900/20">
          <svg 
        ...
        <p className="text-gray-500 mb-8 max-w-sm mx-auto">
          No pudimos localizar al héroe o villano que estás buscando en nuestros archivos de inteligencia.
        </p>

        {/* Botón de acción por si quieres regresar */}
        <button 
          onClick={() => navigate(-1)} 
          className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-xl text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-md hover:shadow-lg"
        >
